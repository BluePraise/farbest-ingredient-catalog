...
class FPC_Taxonomies {
    ...
    /**
     * Register Ingredient Subcategory taxonomy
     */
    private static function register_subcategory() {
        $labels = array(
            'name'              => _x('Ingredient Subcategories', 'Taxonomy General Name', 'farbest-catalog'),
            'singular_name'     => _x('Ingredient Subcategory', 'Taxonomy Singular Name', 'farbest-catalog'),
            'menu_name'         => __('Subcategories', 'farbest-catalog'),
            'all_items'         => __('All Subcategories', 'farbest-catalog'),
            'parent_item'       => __('Parent Subcategory', 'farbest-catalog'),
            'parent_item_colon' => __('Parent Subcategory:', 'farbest-catalog'),
            'new_item_name'     => __('New Subcategory Name', 'farbest-catalog'),
            'add_new_item'      => __('Add New Subcategory', 'farbest-catalog'),
            'edit_item'         => __('Edit Subcategory', 'farbest-catalog'),
            'update_item'       => __('Update Subcategory', 'farbest-catalog'),
            'view_item'         => __('View Subcategory', 'farbest-catalog'),
        );
        ...
        $args = array(
            ...
            'show_in_rest'      => true,
            'rewrite'           => array(
                'slug'        => 'ingredient-subcategory',
                'with_front'  => false,
                'hierarchical' => true,
            ),
        );

        register_taxonomy('fpc_subcategory', array('fpc_ingredient'), $args);
    }
